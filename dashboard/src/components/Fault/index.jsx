...
const Fault = ({ lable, size = "md" }) => {
  return (
    <div
      role="status"
      style={{ textTransform: "capitalize" }}
      aria-live="assertive"
      className={`inline-flex items-center justify-center rounded-full px-4 select-none font-semibold
                  whitespace-nowrap leading-none alarm-invert ${CHIP_SIZES[size]}`}
    >
      {lable}
    </div>
  );
